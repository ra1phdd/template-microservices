...
func Debugf(message string, fields ...zap.Field) {
	logger.Debug(fmt.Sprintf("[auth] %s", message), fields...)
}
...
func Infof(message string, fields ...zap.Field) {
	logger.Info(fmt.Sprintf("[auth] %s", message), fields...)
}
...
func Warnf(message string, fields ...zap.Field) {
	logger.Warn(fmt.Sprintf("[auth] %s", message), fields...)
}
...
func Errorf(message string, fields ...zap.Field) {
	logger.Error(fmt.Sprintf("[auth] %s", message), fields...)
}
...
func Fatalf(message string, fields ...zap.Field) {
	logger.Fatal(fmt.Sprintf("[auth] %s", message), fields...)
}
